...
//    CFStringRef s = CFUUIDCreateString(NULL, (__bridge CFUUIDRef)(sensor.activePeripheral.identifier));  //todocw
//    textFromAdruino.text = (__bridge NSString*)s;
    textFromAdruino.text = sensor.activePeripheral.identifier.UUIDString;
